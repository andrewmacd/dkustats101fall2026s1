...
webr:
  ...
  packages:
    ...
    - knitr
  resources:
    - https://raw.githubusercontent.com/andrewmacd/dkustats101fall2026s1/main/lectures/datasets/nba_2026_clean.csv
    - https://raw.githubusercontent.com/andrewmacd/dkustats101fall2026s1/main/lectures/datasets/titanic.survival.csv
...
nbaboxscores <- read.csv("nba_2026_clean.csv")
...
ggplot(nbaboxscores, aes(x=as.factor(teamid),y=PTS, fill=div)) + 
  geom_boxplot() + 
...
nbaboxscores %>% 
    filter(AST > 40) %>%
    select(game_id, teamid, home.away, PTS, TRB, gameDate)
```
