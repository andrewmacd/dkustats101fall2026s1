...
webr:
  ...
  resources:
    ...
    - https://raw.githubusercontent.com/andrewmacd/dkustats101fall2026s1/main/lectures/datasets/lifeexp.csv
---
...
lifeexp <- read.csv("lifeexp.csv", fileEncoding="UTF-8-BOM")
```
...
### Life expetancy in 2023

```{webr}
#| label: lifexpectancy
#| caption: "Graph of life expectancies"
ggplot(lifeexp, aes(x=X2023)) + 
  geom_histogram(fill="blue4", color="black") +
